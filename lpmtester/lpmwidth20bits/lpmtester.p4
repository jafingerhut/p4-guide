                    ...
                    inout standard_metadata_t stdmeta)
{
    ...
    table ipv6_da_lpm {
        size = 100000;
        key = {
            // We specifically want to test a scenario where the lpm
            // key field has a length in bits that is not a multiple
            // of 8 bits, to test how P4Runtime API bit alignment and
            // BMv2 interpret P4RUntime API messages for adding
            // entries.
            hdr.ipv6.dst_addr[19:0]: lpm;
        }
        actions = {

                    ...
                    inout standard_metadata_t stdmeta)
{
    ...
    table t1 {
        key = {
            ...
            // CustomAddr_t, because of the outer cast.  The
            // auto-generated P4Info file has type CustomAddr_t for
            // this field in it.
            (CustomAddr_t) ((bit<32>) hdr.andycustom.srcAddr + (bit<32>) hdr.ipv4.srcAddr): exact @name("myaddress");
        }
        actions = {
            set_output;
            my_drop;

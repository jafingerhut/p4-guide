...
@p4runtime_translation("https://p4.org/v1/ethernet_address", string)
#endif
type bit<48> ethernet_addr_t;
#ifndef PLATFORM_BMV2
@p4runtime_translation("https://p4.org/v1/ipv4_address", string)
#endif
type bit<32> ipv4_addr_t;
#ifndef PLATFORM_BMV2
@p4runtime_translation("https://p4.org/v1/ipv6_address", string)
#endif
type bit<128> ipv6_addr_t;

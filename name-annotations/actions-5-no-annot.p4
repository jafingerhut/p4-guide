...

{
    ...
    // These lines are only here to make line numbers for action a2 to
    // match between this program and actions-5-same-name-annot.p4,
    // for easier comparison of their BMv2 JSON files.
    //
    //

...
File `p4c-2019-02-18-v1/psa-example-digest-bmv2.psa.p4info.txtpb`
contains the p4info file generated by this command:

```
p4c-bm2-psa --p4runtime-files psa-example-digest-bmv2.psa.p4info.txtpb psa-example-digest-bmv2.p4
```
...
`expected-p4info-files/psa-example-digest-bmv2.psa.p4info.txtpb`.  Note
...
The file
`p4c-2019-02-18-v1/psa-example-counters-variant.psa.p4info.txtpb` was

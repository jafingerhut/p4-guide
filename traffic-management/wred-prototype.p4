                 ...
                 inout standard_metadata_t stdmeta)
{
    ...
    table calc_wred_avg_qdepth_penalty {
        key = {
            meta.class_of_service : exact;
        }
        actions = {
            set_avg_qdepth_penalty;
        }
        const default_action = set_avg_qdepth_penalty(0);
        // # of classes of service in the implementation for this
        // example.
        size = 8;
    }

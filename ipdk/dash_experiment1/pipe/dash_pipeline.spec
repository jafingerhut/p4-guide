...
struct metadata_t {
	...
	bit<8> dash_ingress_outbound_ConntrackOut_conntrackOut_ipv4_protoc1
	...
	bit<16> dash_ingress_outbound_ConntrackOut_conntrackOut_local_metad2
	...
	bit<16> dash_ingress_inbound_ConntrackIn_conntrackIn_local_metadata7
	...
	bit<16> dash_ingress_inbound_ConntrackOut_conntrackOut_local_metada8
...
action outbound_ConntrackOut_conntrackOut_allow_0 args none {
	...
	jmpeq LABEL_END_47 m.MainControlT_tmp_3 0x0
...
action outbound_ConntrackOut_conntrackOut_miss_0 args none {
	...
	jmpneq LABEL_END_48 m.MainControlT_tmp_6 0x2
	jmpneq LABEL_END_48 m.local_metadata__direction1 0x2
...
action outbound_ConntrackIn_conntrackIn_allow_0 args none {
	...
	jmpeq LABEL_END_50 m.MainControlT_tmp_12 0x0
...
action outbound_ConntrackIn_conntrackIn_miss_0 args none {
	...
	jmpneq LABEL_END_51 m.MainControlT_tmp_15 0x2
	jmpneq LABEL_END_51 m.local_metadata__direction1 0x1
...
action outbound_set_tunnel_mapping_0 args instanceof outbound_set_tunnel_mapping_0_arg_t {
	jmpneq LABEL_END_53 t.use_dst_vnet_vni 0x1
	mov m.local_metadata__vnet_id10 m.local_metadata__dst_vnet_id11
	LABEL_END_53 :	mov m.local_metadata__encap_data_overlay_dmac8 t.overlay_dmac
...
action inbound_ConntrackIn_conntrackIn_allow_0 args none {
	...
	jmpeq LABEL_END_54 m.MainControlT_tmp_21 0x0
...
action inbound_ConntrackIn_conntrackIn_miss_0 args none {
	...
	jmpneq LABEL_END_55 m.MainControlT_tmp_24 0x2
	jmpneq LABEL_END_55 m.local_metadata__direction1 0x1
...
action inbound_ConntrackOut_conntrackOut_allow_0 args none {
	...
	jmpeq LABEL_END_57 m.MainControlT_tmp_30 0x0
...
action inbound_ConntrackOut_conntrackOut_miss_0 args none {
	...
	jmpneq LABEL_END_58 m.MainControlT_tmp_33 0x2
	jmpneq LABEL_END_58 m.local_metadata__direction1 0x2
...
action set_eni_attrs args instanceof set_eni_attrs_arg_t {
	...
	jmpneq LABEL_FALSE_56 m.local_metadata__is_overlay_ip_v619 0x1
	jmpneq LABEL_FALSE_57 m.local_metadata__direction1 0x1
	mov m.local_metadata__stage1_dash_acl_group_id29 t.outbound_v6_stage1_dash_acl_group_id
	mov m.local_metadata__stage2_dash_acl_group_id30 t.outbound_v6_stage2_dash_acl_group_id
	mov m.local_metadata__stage3_dash_acl_group_id31 t.outbound_v6_stage3_dash_acl_group_id
	mov m.local_metadata__stage4_dash_acl_group_id32 t.outbound_v6_stage4_dash_acl_group_id
	mov m.local_metadata__stage5_dash_acl_group_id33 t.outbound_v6_stage5_dash_acl_group_id
	jmp LABEL_END_60
	LABEL_FALSE_57 :	mov m.local_metadata__stage1_dash_acl_group_id29 t.inbound_v6_stage1_dash_acl_group_id
	mov m.local_metadata__stage2_dash_acl_group_id30 t.inbound_v6_stage2_dash_acl_group_id
	mov m.local_metadata__stage3_dash_acl_group_id31 t.inbound_v6_stage3_dash_acl_group_id
	mov m.local_metadata__stage4_dash_acl_group_id32 t.inbound_v6_stage4_dash_acl_group_id
	mov m.local_metadata__stage5_dash_acl_group_id33 t.inbound_v6_stage5_dash_acl_group_id
	jmp LABEL_END_60
	LABEL_FALSE_56 :	jmpneq LABEL_FALSE_58 m.local_metadata__direction1 0x1
	mov m.local_metadata__stage1_dash_acl_group_id29 t.outbound_v4_stage1_dash_acl_group_id
	mov m.local_metadata__stage2_dash_acl_group_id30 t.outbound_v4_stage2_dash_acl_group_id
	mov m.local_metadata__stage3_dash_acl_group_id31 t.outbound_v4_stage3_dash_acl_group_id
	mov m.local_metadata__stage4_dash_acl_group_id32 t.outbound_v4_stage4_dash_acl_group_id
	mov m.local_metadata__stage5_dash_acl_group_id33 t.outbound_v4_stage5_dash_acl_group_id
	jmp LABEL_END_60
	LABEL_FALSE_58 :	mov m.local_metadata__stage1_dash_acl_group_id29 t.inbound_v4_stage1_dash_acl_group_id
	mov m.local_metadata__stage2_dash_acl_group_id30 t.inbound_v4_stage2_dash_acl_group_id
	mov m.local_metadata__stage3_dash_acl_group_id31 t.inbound_v4_stage3_dash_acl_group_id
	mov m.local_metadata__stage4_dash_acl_group_id32 t.inbound_v4_stage4_dash_acl_group_id
	mov m.local_metadata__stage5_dash_acl_group_id33 t.inbound_v4_stage5_dash_acl_group_id
	LABEL_END_60 :	return
}
...
action set_acl_group_attrs args instanceof set_acl_group_attrs_arg_t {
	jmpneq LABEL_FALSE_59 t.ip_addr_family 0x0
	jmpneq LABEL_END_63 m.local_metadata__is_overlay_ip_v619 0x1
	mov m.local_metadata__dropped0 1
	jmp LABEL_END_63
	jmp LABEL_END_63
	LABEL_FALSE_59 :	jmpneq LABEL_END_63 m.local_metadata__is_overlay_ip_v619 0x0
	mov m.local_metadata__dropped0 1
	LABEL_END_63 :	return
}
...
table outbound_outbound_ca_to_pa_dash_outbound_ca_to_pa {
	key {
		m.dash_ingress_outbound_outbound_ca_to_pa_dash_outbound_ca_to4 exact
		m.dash_ingress_outbound_outbound_ca_to_pa_dash_outbound_ca_to5 exact
		m.dash_ingress_outbound_outbound_ca_to_pa_dash_outbound_ca_to6 exact
	}
	actions {
...
learner outbound_ConntrackOut_conntrackOut {
	key {
		...
		m.dash_ingress_outbound_ConntrackOut_conntrackOut_ipv4_protoc1
		m.dash_ingress_outbound_ConntrackOut_conntrackOut_retval_1
		m.dash_ingress_outbound_ConntrackOut_conntrackOut_retval_2
		m.dash_ingress_outbound_ConntrackOut_conntrackOut_local_metad2
	}
	actions {
...
learner outbound_ConntrackIn_conntrackIn {
	key {
		...
		m.dash_ingress_outbound_ConntrackIn_conntrackIn_local_metadat3
	}
	actions {
...
learner inbound_ConntrackIn_conntrackIn {
	key {
		...
		m.dash_ingress_inbound_ConntrackIn_conntrackIn_local_metadata7
	}
	actions {
...
learner inbound_ConntrackOut_conntrackOut {
	key {
		...
		m.dash_ingress_inbound_ConntrackOut_conntrackOut_local_metada8
	}
	actions {
...
apply {
	...
	mov m.MainControlT_tmp_35 h.ethernet.src_addr
	jmp LABEL_END_14
	LABEL_FALSE_10 :	mov m.MainControlT_tmp_35 h.ethernet.dst_addr
	LABEL_END_14 :	mov m.local_metadata__eni_addr9 m.MainControlT_tmp_35
	table eni_ether_address_map
	table eni
	...
	mov m.dash_ingress_outbound_ConntrackOut_conntrackOut_ipv4_protoc1 h.ipv4.protocol
	...
	mov m.dash_ingress_outbound_ConntrackOut_conntrackOut_local_metad2 m.local_metadata__eni_id12
	...
	mov m.dash_ingress_outbound_ConntrackIn_conntrackIn_local_metadat3 m.local_metadata__eni_id12
	...
	jmp LABEL_END_16
	LABEL_SWITCH_7 :	mov m.dash_ingress_outbound_outbound_ca_to_pa_dash_outbound_ca_to4 m.local_metadata__dst_vnet_id11
	mov m.dash_ingress_outbound_outbound_ca_to_pa_dash_outbound_ca_to5 m.local_metadata__is_overlay_ip_v619
	mov m.dash_ingress_outbound_outbound_ca_to_pa_dash_outbound_ca_to6 m.local_metadata__dst_ip_addr22
	table outbound_outbound_ca_to_pa_dash_outbound_ca_to_pa
	table outbound_vnet_dash_vnet
	jmp LABEL_END_16
	jmp LABEL_END_16
	LABEL_FALSE_12 :	jmpneq LABEL_END_16 m.local_metadata__direction1 0x2
	jmpneq LABEL_FALSE_28 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_7 h.ipv4.src_addr
	jmp LABEL_END_32
	LABEL_FALSE_28 :	mov m.MainControlT_retval_7 h.ipv4.dst_addr
	LABEL_END_32 :	jmpneq LABEL_FALSE_29 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_8 h.ipv4.dst_addr
	jmp LABEL_END_33
	LABEL_FALSE_29 :	mov m.MainControlT_retval_8 h.ipv4.src_addr
	LABEL_END_33 :	jmpneq LABEL_FALSE_30 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_9 h.tcp.src_port
	jmp LABEL_END_34
	LABEL_FALSE_30 :	mov m.MainControlT_retval_9 h.tcp.dst_port
	LABEL_END_34 :	jmpneq LABEL_FALSE_31 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_10 h.tcp.dst_port
	jmp LABEL_END_35
	LABEL_FALSE_31 :	mov m.MainControlT_retval_10 h.tcp.src_port
	LABEL_END_35 :	mov m.dash_ingress_inbound_ConntrackIn_conntrackIn_retval m.MainControlT_retval_7
	...
	mov m.dash_ingress_inbound_ConntrackIn_conntrackIn_local_metadata7 m.local_metadata__eni_id12
	table inbound_ConntrackIn_conntrackIn
	jmpneq LABEL_FALSE_32 m.local_metadata__conntrack_data_allow_in25 0x1
	jmp LABEL_END_36
	LABEL_FALSE_32 :	mov m.MainControlT_inbound_acl_hasReturned 0
	jmpeq LABEL_END_37 m.local_metadata__stage1_dash_acl_group_id29 0x0
	table inbound_acl_stage1_dash_acl_rule_dash_acl
	...
	LABEL_END_37 :	jmpneq LABEL_FALSE_34 m.MainControlT_inbound_acl_hasReturned 0x1
	jmp LABEL_END_38
	LABEL_FALSE_34 :	jmpeq LABEL_END_38 m.local_metadata__stage2_dash_acl_group_id30 0x0
	table inbound_acl_stage2_dash_acl_rule_dash_acl
	...
	LABEL_END_38 :	jmpneq LABEL_FALSE_36 m.MainControlT_inbound_acl_hasReturned 0x1
	jmp LABEL_END_36
	LABEL_FALSE_36 :	jmpeq LABEL_END_36 m.local_metadata__stage3_dash_acl_group_id31 0x0
	table inbound_acl_stage3_dash_acl_rule_dash_acl
	LABEL_END_36 :	jmpneq LABEL_FALSE_38 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_11 h.ipv4.src_addr
	jmp LABEL_END_42
	LABEL_FALSE_38 :	mov m.MainControlT_retval_11 h.ipv4.dst_addr
	LABEL_END_42 :	jmpneq LABEL_FALSE_39 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_12 h.ipv4.dst_addr
	jmp LABEL_END_43
	LABEL_FALSE_39 :	mov m.MainControlT_retval_12 h.ipv4.src_addr
	LABEL_END_43 :	jmpneq LABEL_FALSE_40 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_13 h.tcp.src_port
	jmp LABEL_END_44
	LABEL_FALSE_40 :	mov m.MainControlT_retval_13 h.tcp.dst_port
	LABEL_END_44 :	jmpneq LABEL_FALSE_41 m.local_metadata__direction1 0x1
	mov m.MainControlT_retval_14 h.tcp.dst_port
	jmp LABEL_END_45
	LABEL_FALSE_41 :	mov m.MainControlT_retval_14 h.tcp.src_port
	LABEL_END_45 :	mov m.dash_ingress_inbound_ConntrackOut_conntrackOut_retval m.MainControlT_retval_11
	...
	mov m.dash_ingress_inbound_ConntrackOut_conntrackOut_local_metada8 m.local_metadata__eni_id12
	...
	table eni_meter
	jmpneq LABEL_END_46 m.local_metadata__dropped0 0x1
	drop
	LABEL_END_46 :	emit h.ethernet
	emit h.ipv4
	emit h.ipv4options
	emit h.ipv6
	emit h.udp

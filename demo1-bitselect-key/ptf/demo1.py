...
class Demo1Test(bt.P4RuntimeTest):
    ...
    def key_ipv4_da_lpm(self, ipv4_addr_int, prefix_len):
        return ('ipv4_da_lpm',
                [self.Lpm('hdr.ipv4.dstAddr[23:8]',
                          ipv4_addr_int, prefix_len)])
...
class FwdTest(Demo1Test):
    ...
    def runTest(self):
        ...
        # addresses.
        self.table_add(self.key_ipv4_da_lpm(ip_dst_addr_middle, 8),
...
class DupEntryTest(Demo1Test):
    ...
    def runTest(self):
        ...
        def add_entry_once():
            self.table_add(self.key_ipv4_da_lpm(ip_dst_addr, 16),
                           self.act_set_l2ptr(l2ptr))

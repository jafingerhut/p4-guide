...
def add_ipv4_da_lpm_entry_action_set_l2ptr(ipv4_addr_int, prefix_len_int,
                                           l2ptr_int):
    ...
    if prefix_len_int != 0:
        te.match['dstAddr[23:8]'] = '%d/%d' % (ipv4_addr_int, prefix_len_int)
...
class FwdTest(Demo1Test):
    def runTest(self):
        ...
        # addresses.
        add_ipv4_da_lpm_entry_action_set_l2ptr(ip_dst_addr_middle, 8, l2ptr)
...
class PrefixLen0Test(Demo1Test):
    def runTest(self):
        ...
        entries.append({'ip_dst_addr': 0x0100, # '10.1.0.1',
                        'prefix_len': 16, # 32,
                        ...
                        'out_dmac': '02:13:57:ab:cd:ef',
                        'out_smac': '00:11:22:33:44:55'})
        entries.append({'ip_dst_addr': 0x0100, # '10.1.0.0',
                        'prefix_len': 8, # 16,
        ...
        entries.append({'ip_dst_addr': 0x0000, # '0.0.0.0',
                        'prefix_len': 0,
...
class DupEntryTest(Demo1Test):
    def runTest(self):
        ip_dst_addr = 0x0000 # '10.0.0.1'
        l2ptr = 58

        def add_entry_once():
            add_ipv4_da_lpm_entry_action_set_l2ptr(ip_dst_addr, 16, l2ptr)
